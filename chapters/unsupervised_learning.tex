...
\begin{table}[h]
	\centering
	\caption{Mean test accuracies of the CNN classifiers with different pre-training (95\% confidence intervals in parentheses).}
	...
	\resizebox{\textwidth}{!}{%
		\begin{tabular}{r|rrrrr}
			...
			10     & 0.500 (0.0000) & 0.558 (0.0042) & 0.557 (0.0083)          & 0.547 (0.0062)          & \textbf{0.590 (0.0094)} \\
			32     & 0.563 (0.0106) & 0.563 (0.0044) & \textbf{0.603 (0.0040)} & 0.541 (0.0076)          & 0.580 (0.0077)          \\
			100    & 0.653 (0.0103) & 0.592 (0.0016) & 0.629 (0.0080)          & 0.598 (0.0071)          & \textbf{0.657 (0.0082)} \\
			316    & 0.692 (0.0058) & 0.589 (0.0095) & \textbf{0.740 (0.0013)} & 0.715 (0.0037)          & 0.709 (0.0057)          \\
			1000   & 0.725 (0.0013) & 0.758 (0.0012) & 0.739 (0.0015)          & 0.760 (0.0014)          & \textbf{0.773 (0.0005)} \\
			3162   & 0.750 (0.0002) & 0.775 (0.0027) & 0.774 (0.0011)          & 0.784 (0.0006)          & \textbf{0.785 (0.0014)} \\
			10000  & 0.786 (0.0005) & 0.787 (0.0008) & 0.777 (0.0012)          & \textbf{0.792 (0.0033)} & 0.781 (0.0017)          \\
			31624  & 0.781 (0.0011) & 0.774 (0.0003) & 0.770 (0.0008)          & \textbf{0.785 (0.0005)} & 0.784 (0.0008)          \\
			100000 & 0.775 (0.0006) & 0.774 (0.0011) & \textbf{0.786 (0.0003)} & 0.784 (0.0006)          & 0.784 (0.0009)
		\end{tabular}%
	}
\end{table}
...
% Discuss results more including confidence and tolerance intervals.
