...
% TODO - Remove Diagnal arrows from figure.
...
% TODO - Maybe remove figure reference or add new figure or add page number to reference.
...
% TODO - This needs to be futher explained and ilistrated.
...
% TODO - Caption should be more extensive and explain modification of pixelCNN.
...
% TODO - Expand on dataset to make it clear I did not make the dataset.
...
% TODO - Explain the parameters of the CPC and where they come from.
...
% TODO - Add that Chapter 2 and 3 arn't directly comparatable.

% TODO - Perform statistical analaysis on the results (bootstraping) and add them to tables and plots.
