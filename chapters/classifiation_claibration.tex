...
\begin{figure}[!h]
	...
	\begin{tabular}{cc}
		\subcaptionbox{\centering Melanoma}{\includegraphics[width=1.7in]{images/MEL.jpg}} &
		\subcaptionbox{\centering Melanocytic \mbox{Nevus}}{\includegraphics[width=1.7in]{images/nv_example.jpeg}} \\
		\subcaptionbox{\centering Basal Cell \mbox{Carcinoma}}{\includegraphics[width=1.7in]{images/bcc_example.jpeg}} &
		\subcaptionbox{\centering Actinic Keratosis}{\includegraphics[width=1.7in]{images/ak_example.jpeg}} \\
		\subcaptionbox{\centering Benign Keratosis}{\includegraphics[width=1.7in]{images/bkl_example.jpeg}} &
		\subcaptionbox{\centering Dermatofibroma}{\includegraphics[width=1.7in]{images/df_example.jpeg}} \\
		\subcaptionbox{\centering Vascular Lesion}{\includegraphics[width=1.7in]{images/vasc_example.jpeg}} &
		\subcaptionbox{\centering Squamous Cell Carcinoma}{\includegraphics[width=1.7in]{images/scc_example.jpeg}}
	\end{tabular}
