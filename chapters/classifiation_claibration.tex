...
\begin{figure}[!h]
	...
	\begin{tabular}{cc}
		\subcaptionbox{Melanoma}{\includegraphics[width=1.7in]{images/MEL.jpg}} &
		\subcaptionbox{Melanocytic \mbox{Nevus}}{\includegraphics[width=1.7in]{images/nv_example.jpeg}} \\
		\subcaptionbox{Basal Cell \mbox{Carcinoma}}{\includegraphics[width=1.7in]{images/bcc_example.jpeg}} &
		\subcaptionbox{Actinic Keratosis}{\includegraphics[width=1.7in]{images/ak_example.jpeg}} \\
		\subcaptionbox{Benign Keratosis}{\includegraphics[width=1.7in]{images/bkl_example.jpeg}} &
		\subcaptionbox{Dermatofibroma}{\includegraphics[width=1.7in]{images/df_example.jpeg}} \\
		\subcaptionbox{Vascular Lesion}{\includegraphics[width=1.7in]{images/vasc_example.jpeg}} &
		\subcaptionbox{Squamous Cell Carcinoma}{\includegraphics[width=1.7in]{images/scc_example.jpeg}}
	\end{tabular}
