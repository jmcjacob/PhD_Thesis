...
To improve annotation efficiency and reduce costs, this chapter proposes a modified active learning framework to improve annotator throughput by selecting large tiles of whole-slide images to be annotated rather than annotating individual nuclei patches. This modified framework was tested using various active learning query strategies on a nuclei detection and classification task using the CRCHistoPhenotypes dataset~\citep{sirinukunwattana2016locality}.

% TODO - Clarify that tiles are larger than patches.
...
% TODO - Add citation and explination about softmax and its unreliable nature.
...
% TODO - Replace figure with something better
\begin{figure}[h]
	\centering
...
% TODO - Justify that the using clicks is a good way to measure the effort needed to annotate an image.
...
% TODO - Add active component to algorithm
% TODO - Add block diagram of algorithm
...
% TODO - Explain why results are only using Tile-based active learning and not patch based.
...
% TODO - Draw more depth from the results, explain why different query methods performed differently.
