...
\begin{table}[h]
	...
	\resizebox{\textwidth}{!}{%
		\begin{tabular}{|ll|r|r|r|r|r|}
			\hline
			&                             & \textbf{ISIC 2019} & \textbf{SD-260} & \textbf{Tayside} & \textbf{Forth Valley} & \textit{\textbf{Total}} \\ \hline
			\multicolumn{1}{|l|}{\textbf{Benign}} & Actinic keratosis (B52)     & 867                & 1434            & 414              & 144        &    \textit{2859}        \\
			\multicolumn{1}{|l|}{}                & Dermatofibroma (X9002)      & 239                & 303             & 56               & 78         &    \textit{676}         \\
			\multicolumn{1}{|l|}{}                & Naevus, melanocytic (X31z)  & 12875              & 1401            & 577              & 531        &    \textit{15384}       \\
			\multicolumn{1}{|l|}{}                & Seborrhoeic keratosis (X01) & 2624               & 1133            & 538              & 290        &    \textit{4585}        \\ \hline
			...
			91 &
			\textit{912} \\
			\multicolumn{1}{|l|}{}                & Basal cell carcinoma (X20)  & 3323               & 2432            & 379              & 179            &   \textit{6313}    \\ \hline
			\textit{\textbf{Total}}               & \textit{}                   & \textit{25078}     & \textit{13814}  & \textit{2218}    & \textit{1518}  &   \textit{42628}    \\ \hline
		\end{tabular}%
	}
\end{table}
...
\begin{table}[h]
	...
	\resizebox{\textwidth}{!}{%
		\begin{tabular}{ll|rrrr|}
			\cline{3-6}
			&  & \multicolumn{4}{c|}{Testing Data} \\ \hline
			\multicolumn{1}{|l|}{Model} & Training Data & \multicolumn{1}{l|}{ISIC 2019} & \multicolumn{1}{l|}{SD-260} & \multicolumn{1}{l|}{Tayside} & \multicolumn{1}{l|}{Forth Valley} \\ \hline
			\multicolumn{1}{|l|}{\multirow{4}{*}{\textbf{CNN}}} & ISIC 20109 & \multicolumn{1}{r|}{\textbf{0}} & \multicolumn{1}{r|}{0} & \multicolumn{1}{r|}{0} & 0 \\
			\multicolumn{1}{|l|}{} & SD-260 & \multicolumn{1}{r|}{0} & \multicolumn{1}{r|}{\textbf{0}} & \multicolumn{1}{r|}{0} & 0 \\
			\multicolumn{1}{|l|}{} & Tayside & \multicolumn{1}{r|}{} & \multicolumn{1}{r|}{} & \multicolumn{1}{r|}{\textbf{0}} & 0 \\
			\multicolumn{1}{|l|}{} & Forth Valley & \multicolumn{1}{r|}{} & \multicolumn{1}{r|}{} & \multicolumn{1}{r|}{0} & \textbf{0} \\ \hline
			\multicolumn{1}{|l|}{\multirow{4}{*}{\textbf{SWIN}}} & ISIC 2019 & \multicolumn{1}{r|}{\textbf{0}} & \multicolumn{1}{r|}{0} & \multicolumn{1}{r|}{0} & 0 \\
			\multicolumn{1}{|l|}{} & SD-260 & \multicolumn{1}{r|}{0} & \multicolumn{1}{r|}{\textbf{0}} & \multicolumn{1}{r|}{0} & 0 \\
			\multicolumn{1}{|l|}{} & Tayside & \multicolumn{1}{r|}{} & \multicolumn{1}{r|}{} & \multicolumn{1}{r|}{\textbf{0}} & 0 \\
			\multicolumn{1}{|l|}{} & Forth Valley & \multicolumn{1}{r|}{} & \multicolumn{1}{r|}{} & \multicolumn{1}{r|}{0} & \textbf{0} \\ \hline
		\end{tabular}%
...
\begin{table}[h]
	\centering
	\caption{Balanced class accuracy when EfficientNet CNN and SWIN transformers are tested on Tayside and Forth Valley data after various multi-dataset training sequences.}
	\label{tab:generalisation_models}
	\resizebox{\textwidth}{!}{%
		\begin{tabular}{ll|rr|}
			\cline{3-4}
			&  & \multicolumn{2}{c|}{Testing Dataset} \\ \hline
			\multicolumn{1}{|l|}{Model} & Training Dataset & \multicolumn{1}{l|}{Tayside} & \multicolumn{1}{l|}{Forth Valley} \\ \hline
			\multicolumn{1}{|l|}{\multirow{8}{*}{\textbf{CNN}}} & SD-260, ISIC 2019 & \multicolumn{1}{r|}{0} & 0 \\
			\multicolumn{1}{|l|}{} & ISIC 2019, SD-260 & \multicolumn{1}{r|}{0} & 0 \\
			\multicolumn{1}{|l|}{} & ISIC 2019, Tayside & \multicolumn{1}{r|}{0} & 0 \\
			\multicolumn{1}{|l|}{} & SD-260, Tayside & \multicolumn{1}{r|}{0} & 0 \\
			\multicolumn{1}{|l|}{} & ISIC, SD-260, Tayside & \multicolumn{1}{r|}{0} & 0 \\
			\multicolumn{1}{|l|}{} & ISIC 2019, Forth Valley & \multicolumn{1}{r|}{0} & 0 \\
			\multicolumn{1}{|l|}{} & SD-260, Forth Valley & \multicolumn{1}{r|}{0} & 0 \\
			\multicolumn{1}{|l|}{} & ISIC, SD-260, Forth Valley & \multicolumn{1}{r|}{0} & 0 \\ \hline
			\multicolumn{1}{|l|}{\multirow{8}{*}{\textbf{SWIN}}} & SD-260, ISIC 2019 & \multicolumn{1}{r|}{0} & 0 \\
			\multicolumn{1}{|l|}{} & ISIC 2019, SD-260 & \multicolumn{1}{r|}{0} & 0 \\
			\multicolumn{1}{|l|}{} & ISIC 2019, Tayside & \multicolumn{1}{r|}{0} & 0 \\
			\multicolumn{1}{|l|}{} & SD-260, Tayside & \multicolumn{1}{r|}{0} & 0 \\
			\multicolumn{1}{|l|}{} & ISIC, SD-260, Tayside & \multicolumn{1}{r|}{0} & 0 \\
...
\begin{figure}[!h]
	...
	\end{tabular}
	\caption{Balanced accuracy of the models demonstrating the performance of cross-dataset fine-tuning between the Tayside and Forth Valley datasets.}
