...
\begin{figure}[!th]
	...
	\captionsetup[subfigure]{singlelinecheck=false}
	\begin{tabular}{c}
		\subcaptionbox{\centering Testing on the Tayside dataset.}{\includegraphics[width=\textwidth]{images/tayside_model.png}} \\
		\subcaptionbox{\centering Testing on the Forth Valley dataset.}{\includegraphics[width=\textwidth]{images/forth_valley_model.png}}
	\end{tabular}
...
\begin{figure}[!h]
	...
	\captionsetup[subfigure]{singlelinecheck=false}
	\begin{tabular}{c}
		\subcaptionbox{\centering Testing on the Tayside dataset.}{\includegraphics[width=\textwidth]{images/tayside_testing.png}} \\
		\subcaptionbox{\centering Testing on the Forth Valley dataset.}{\includegraphics[width=\textwidth]{images/forth_valley_testing.png}}
	\end{tabular}
...
\begin{figure}[h]
	...
	\captionsetup[subfigure]{singlelinecheck=false}
	\begin{tabular}{c}
		\subcaptionbox{\centering ROC curve for EfficientNet CNN classifiers.}{\includegraphics[width=0.8\textwidth]{images/cnn_roc.png}} \\
		\subcaptionbox{\centering ROC curve for SWIN transformer classifiers.}{\includegraphics[width=0.8\textwidth]{images/swin_roc.png}}
	\end{tabular}
